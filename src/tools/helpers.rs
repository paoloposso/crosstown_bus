...
pub(crate) fn get_exchange_name(queue_name: &String) -> String {
...
pub(crate) fn create_exchange<'a>(queue_name: &'a String, exchange_type: String, channel: &'a amiquip::Channel) -> amiquip::Exchange<'a> {
    let ex_type;
    ...
    let exchange_name = crate::tools::helpers::get_exchange_name(queue_name);
